...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            user::list_friends,
            user::list_friendships,
            user::list_friend_categories,
            user::create_friend_category,
            user::rename_friend_category,
            user::delete_friend_category,
            user::set_friend_category,
