/** biome-ignore-all lint/correctness/useExhaustiveDependencies: We intentionally do not include toggleSidebar in the dependencies of the useEffect that adds the keyboard shortcut, because we don't want the keyboard shortcut to change if toggleSidebar changes. */
"use client";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: We need to set a cookie to persist the sidebar state.
