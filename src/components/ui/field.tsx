...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: The container element is a div to allow flexible layout and content.
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: This is a list of unique error messages, so the index is stable.
